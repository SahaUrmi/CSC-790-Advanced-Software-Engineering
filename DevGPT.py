...
Conversion Date: 2025-12-06T06:07:46.660Z
"""

import pandas as pd

# Load the labeled dataset
df_llm = pd.read_csv("PR_dataset.csv")  # Update this path to your dataset location
...
plt.title('DevGPT: Distribution of Merged PRs by Time-to-Integration Categories')
...
plt.title('DevGPT: Distribution of Merged PRs by Update Interval Categories')
...
plt.title('DevGPT: Distribution of Merged PRs by Number of Commits Categories')
...
plt.title('DevGPT: Distribution of Merged PRs by Changed Files Categories')
...
plt.title('DevGPT: Distribution of Merged PRs by Lines Added Categories')
...
plt.title('DevGPT: Distribution of Merged PRs by Lines Deleted Categories')
...
axes[0, 0].set_title('DevGPT: Distribution of Merged PRs by Number of Commits Categories')
...
axes[0, 1].set_title('DevGPT: Distribution of Merged PRs by Changed Files Categories')
...
axes[1, 0].set_title('DevGPT: Distribution of Merged PRs by Lines Added Categories')
...
axes[1, 1].set_title('DevGPT: Distribution of Merged PRs by Lines Deleted Categories')
